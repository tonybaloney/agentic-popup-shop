    ...
    publishing_agent = AgentExecutor(
        agent=AzureAIAgentClient(
            ...
            instructions=(
                ...
                "- The FIRST entry in the JSON array MUST be a video post\n"
                "- MUST be in English (language: 'English')\n"
                "- MUST be set to post immediately (use TODAY's date and current time in PST)\n"
                "- MUST use content_type: 'Video'\n"
                "- Can be either Instagram Reel or TikTok Video\n"
                ...
                "Create 8-12 posts over 2 weeks, starting with the MANDATORY immediate video post. Include both English and all localized versions provided."
            ),
        ),
        id="publishing_agent",
    )
